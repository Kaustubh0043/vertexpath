      ...
      <form onSubmit={handleGenerate} className="bg-[var(--card)] border border-[var(--border)]/80 p-4 rounded-2xl flex flex-wrap items-center gap-4 shadow-xl">
        ...
        <div className="self-end pt-5">
          <button
            ...
            className="px-6 py-2.5 bg-[#8B5CF6] hover:bg-[#C49AFF] text-[#111318] rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center gap-2 shadow-lg shadow-[#8B5CF6]/20"
          >
            ...
            <div className="bg-[var(--card)] border border-[var(--border)]/80 rounded-2xl overflow-hidden shadow-xl">
              ...
              <div className="flex items-center justify-between px-4 py-3 bg-[#11151D] border-t border-[var(--border)]">
                ...
                <button
                  ...
                  className="px-6 py-2 bg-[#55D39A] hover:bg-[#6ef0b4] text-[#111318] text-xs font-bold rounded-xl transition-all cursor-pointer flex items-center gap-2 shadow-lg shadow-[#55D39A]/20"
                >
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="flex items-center gap-1 text-[11px] text-[#8B5CF6] hover:underline cursor-pointer font-bold"
                      >
